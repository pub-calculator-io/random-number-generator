...
Version: 1.0.0
Author: Random Number Generator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Random Number Generator by www.calculator.io";

function display_calcio_ci_random_number_generator(){
    $page = 'index.html';
...
add_shortcode( 'ci_random_number_generator', 'display_calcio_ci_random_number_generator' );