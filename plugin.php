<?php
/*
Plugin Name: Random Number Generator by Calculator.iO
...
function display_ci_random_number_generator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/random-number-generator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Random Number Generator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_random_number_generator_iframe"></iframe></div>';
}
